...
{
    return (
        <main className="min-h-screen flex flex-col flex-grow my-8">
            <div className="text-slate-800 mx-4 mt-4 p-4 bg-gradient-to-r from-slate-50 to bg-slate-100 border-slate-100 rounded-md shadow-md">
