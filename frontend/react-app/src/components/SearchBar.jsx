...
function SearchBar({ setSearchResults }) {
  ...
  return (
    <div className="fixed top-16 mt-2 mx-6 left-0 right-0 z-10 h-16 flex items-center justify-center">
      <div className="relative flex items-center w-full max-w-[800px] min-w-min">
        <input
          type="text"
          className="w-full px-4 py-4 rounded-full bg-slate-300 text-gray-700 focus:outline-none focus:ring-2 focus:ring-slate-800 focus:ring-opacity-60"
